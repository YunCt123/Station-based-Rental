                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {list.map((c) => (
                        <tr key={c.id} className="hover:bg-gray-50 ">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center">{c.totalRentals}</td>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-right">
                            ...
                            <Link to={`/admin/customers/profiles/${c.id}/edit`} className="inline-flex items-center text-sm text-blue-600">
                              <EditOutlined  className="mr-7 text-xl" />
                            </Link>
                            <Link to={`/admin/customers/profiles/${c.id}/delete`} className="inline-flex items-center text-sm text-blue-600">
