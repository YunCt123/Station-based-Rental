...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      // Cố định top-right, xếp dọc từ trên xuống, có khoảng cách
      "fixed top-4 right-4 z-[100] flex max-h-screen w-full md:w-[420px] flex-col gap-3 p-4 outline-none",
      className
    )}
    {...props}
  />
...
const toastVariants = cva(
  [
    ...
    // Luôn trượt vào từ TRÊN (bỏ sm:slide-in-from-bottom-full)
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ...
    className={cn(
      ...
      "group-hover:opacity-100 group-[.destructive]:text-red-300 hover:text-foreground group-[.destructive]:hover:text-red-50",
      "focus:opacity-100 focus:outline-none focus:ring-2 group-[.destructive]:focus:ring-red-400 group-[.destructive]:focus:ring-offset-red-600",
      className
    )}
    toast-close=""
    {...props}
