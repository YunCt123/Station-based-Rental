            ...
            {deliveryVehicle ? (
              <div className="mb-6 bg-blue-50 rounded-lg p-6 border border-blue-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="bg-white rounded-lg p-4">
                    <div className="text-sm text-gray-600">Model xe</div>
                  ...
                  <div className="bg-white rounded-lg p-4">
                    ...
                    <div className="font-semibold text-yellow-600">Đang kiểm tra</div>
                  </div>
                </div>
              </div>
            ) : (
              <div className="mb-6 bg-yellow-50 rounded-lg p-6 border border-yellow-200">
                <div className="text-yellow-800">
                  ...
                  <div className="text-sm mt-1">Vui lòng chọn xe từ danh sách xe có sẵn hoặc xe đã đặt trước.</div>
                </div>
              </div>
            )}
