      ...
      try {
        ...
        setResult({
          ...
          subTitle: callbackResult.status === "SUCCESS"
            ...
            : `Mã lỗi: ${rawParams.vnp_ResponseCode} - Giao dịch đã bị hủy`,
